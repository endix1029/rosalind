...
public class Src_BA3I {
	...
	public static void main(String[] args) throws java.io.IOException {
		...
		String univ = "";
		univ += kmer.get(cycle.get(0));
		cycle.remove(0);
		for(int v : cycle) {
			univ += kmer.get(v).charAt(k - 2);
		}
		
		file.write(univ.substring(0, 1 << k));
		file.close();
	}
}
